...
#TEST_EXAMINATION_RESULT_CREATE{
 ...
 #Information_Student_Test_Marks,#hidden_value,#Admit_card,#EXAMINATION_RESULT_DECLARE,#TEST_EXAMINATION_RESULT_DECLARE,#Roll_Number_stundent,#Registration{
	visibility: hidden;
	width: 84.3%;
	max-height: 100%;
	position: absolute;
	...
	<table style="border:1px solid blue; width: 90%; height: 130px; text-align: center; border-collapse: collapse; border-color: blue;background-color: white; margin: 40px 40px;">
	    ...
	    <tr>	
			<form method="post" id="Registration_open">
				...
				<input type="checkbox" name='a' value='true' id="checkbox">
